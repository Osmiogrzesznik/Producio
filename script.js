...
$("sAvginp").value= (preset.averageCycle_ms)? 
msToDHMS(preset.averageCycle_ms,"HH:MM") : $("sAvginp").value;

$("sAvgSecinp").selectedIndex= (preset.averageCycle_ms)? 
msToDHMS(preset.averageCycle_ms,"s") : $("sAvgSecinp").selectedIndex;

$("trgtinp").value= (preset.orderSize)?
preset.orderSize : $("trgtinp").value;



/*
$("").value/selectedIndex=(preset.prop)?
preset.prop : $("").value
*/
...
let sAvgSec = $('sAvgSecinp').selectedIndex;
...
$('frm2').innerHTML = $('inputs').innerHTML;
/*
$("").value =
*/

$('frm1').innerHTML = '';
$("sofarinp").value = soFar;
$("trgtinp").value = toDo;
$("endprodinp").selectedIndex = endProdSelInd;
$("endprodtiminp").value = timeEnd[0]+":"+timeEnd[1];
$("sAvginp").value = sAvg;
$("sAvgSecinp").value = sAvgSec;
$("pphinp").value = spph;
}
...
if (mode){
   //  alert([mode,presetName,prefix]);
	...
	$('datasave').innerHTML = JSON.stringify(datasave.preset) 
	
	presets.push(datasave.preset);
	$("presetsinp").innerHTML = "";
...
setInpStartVals(presets[$('presetsinp').selectedIndex])
...
/*
$('sAvginp').disabled = caller.value ? true : false;
$('sAvgSecinp').disabled = caller.value ? true : false;*/
